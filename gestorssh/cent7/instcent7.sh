...
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-10s\n' "INSTALAR PWEB TECH-CLOUD CENTOS 7" ; tput sgr0 ; echo ""
echo "Continuar? S\n"
echo -n "> "
read option
if [ $option = "S" ]; then
...
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/cent7/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/gestorssh.zip > /dev/null 2>&1
...
createdb(){
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/bdgestorssh.sql > /dev/null 2>&1
...
cd /bin || exit
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/userteste.sh
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/autobackup.sh
