#!/bin/bash
clear
echo -e "\033[1;36mINSTALANDO O SINCRONIZADOR PWEB\033[0m"
...
sleep 1.5
echo -e "\033[1;36mINSTALANDO UMA LICENÇA...\033[0m"
rm *.sh* > /dev/null 2>&1
rm *.zip > /dev/null 2>&1
apt install unzip -y > /dev/null 2>&1
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/sshplus.zip.001 > /dev/null 2>&1
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/sshplus.zip.002 > /dev/null 2>&1
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/sincpainel.zip > /dev/null 2>&1
