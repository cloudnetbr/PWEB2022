...
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-10s\n' "Instalador PainelWEB TECH-CLOUD 🚀 CENTOS 7" ; tput sgr0 ; echo ""
echo "Continuar? Y\n"
echo -n "> "
read option
if [ $option = "Y" ]; then
...
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf
...
installweb(){
cd /var/www/html
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/gestorssh.zip
unzip gestorssh.zip
...
createdb(){
wget https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/bdgestorssh.sql
...
cd $HOME || exit
wget -qO- https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/uteste > /bin/usersteste.sh
wget -qO- https://raw.githubusercontent.com/cloudnetbr/PWEB2022/main/gestorssh/backupauto > /bin/autobackup.sh
